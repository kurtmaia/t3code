...
export function createFilesystemEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    discoverRepositories: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:filesystem:discover-repositories",
      tag: WS_METHODS.filesystemDiscoverRepositories,
    }),
  };
}
